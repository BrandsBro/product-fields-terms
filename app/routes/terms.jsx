  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Terms of Service — Product Options and Terms</title>
        <style>{`
      ...
      <body>
        ...
        <div className="content">
          ...
          <p>By installing and using Product Options and Terms, you agree to be bound by these Terms of Service.</p>

          <h2>2. Description of Service</h2>
          <p>Product Options and Terms is a Shopify application that allows merchants to add custom fields to their product pages and collect customer information at checkout.</p>
          ...
          <p>Product Options and Terms is provided "as is" without warranties of any kind. We are not liable for any damages arising from the use of our service.</p>
        ...
        <footer>
          <p>© 2026 Product Options and Terms. <a href="/">Home</a> · <a href="/privacy">Privacy Policy</a></p>
        </footer>
      </body>
    </html>
  );
